...
class MyAccess extends StatefulWidget {
  ...
  @override
  _MyAccess createState() => _MyAccess();
}

class _MyAccess extends State<MyAccess> {
...
CollectionReference prod = Firestore.instance.collection("accessories");
...
SizedBox(height:10.0),
     Text("Showing result for Accessories", style: TextStyle(fontFamily:"Montserrat", fontSize:18.0),textAlign: TextAlign.center,),
SizedBox(height:10.0),
