...
class AddAccess extends StatefulWidget {
  ...
  @override
  _AddAccess createState() => _AddAccess();
}

class _AddAccess extends State<AddAccess> {
...
saveDataInUser(String name, String author, String price, String category, String url1, String url2, String url3, String subcat, String desc, String postedby){
  DocumentReference documentReference = Firestore.instance.collection(globals.userName).document("accessories").collection(globals.userName).document(name);
...
saveDataInPost(String name, String author, String price, String category, String url1, String url2, String url3, String subcat, String desc, String postedby){
  ...
  print("1"+url2);
  print("1"+url3);
  DocumentReference documentReference = Firestore.instance.collection("accessories").document(name);
    Map<String,String> details = {
    "name": name,
    "condition": author,
    "price": price,
...
pictureUrl3 = "https://studyshare.s3.amazonaws.com/images/"+path.basename(image.path);
...
body: Column(children:[
  Padding(padding:EdgeInsets.only(top:20.0, left:50.0, right:50.0),
    child:Text("Fill the below details to list items for selling..", style: TextStyle(fontFamily:"Montserrat", fontSize:18.0),textAlign: TextAlign.center,),),
SizedBox(height: 30.0,),

Form(key: _formkey, child:Expanded(child: ListView(children:[
  Padding(padding:EdgeInsets.only(top:0.0, left:30.0, right:50.0),
child:Text("Name:", style: TextStyle(fontFamily:"Montserrat", fontSize:15.0, fontWeight: FontWeight.bold),),
  ),
...
SizedBox(height:15.0),
  ...
  Padding(padding:EdgeInsets.only(top:0.0, left:30.0, right:50.0),
child:Text("Condition of item:", style: TextStyle(fontFamily:"Montserrat", fontSize:15.0, fontWeight: FontWeight.bold),),
  ),
Padding(padding:EdgeInsets.only(top:0.0, left:50.0, right:50.0),
child:TextFormField(
  ...
  style: TextStyle(fontFamily:"Montserrat", fontSize:15.0,),
                      validator: (value){
                        if(value.isEmpty){
                          return "Please enter a proper text!";
                        }
                      },
...
SizedBox(height:15.0),
  ...
  Padding(padding:EdgeInsets.only(top:0.0, left:30.0, right:50.0),
child:Text("Item Category:", style: TextStyle(fontFamily:"Montserrat", fontSize:15.0, fontWeight: FontWeight.bold),),
  ),
...
child:DropdownButton<String>(
      ...
      items: <String>['School', 'College', 'Degree']
